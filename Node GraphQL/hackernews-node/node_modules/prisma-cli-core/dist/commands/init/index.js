...
var Init = /** @class */ (function (_super) {
    ...
    Init.prototype.runInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var files, endpointDialog, results, relativeDir, definitionPath, prismaYml, newPrismaYml, dir, dirString, isLocal, dbType, beautifulDbTypesMap, beautifulDbType, steps, dockerComposeInstalled;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
